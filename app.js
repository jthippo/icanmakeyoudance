...
while (rateYourself < 1 || rateYourself > 10) {
    rateYourself = prompt("Do it properly or I'm calling the police. Rate your dance ability on a scale of 1-10.")
}
...
message = "<br>You have rated yourself as having a dance ability of " + rateYourself + " out of 10. " + message;
